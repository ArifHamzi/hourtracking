...
// Fetch Guidance reports
$query = $conn->prepare("
    SELECT G.id, G.referenceNo, G.activityProgram, G.documentationReflection, 
           G.hoursSubmitted, G.uploadedFile, G.status
    FROM Report R
        ...
        <table>
            ...
            <?php foreach ($reports as $report): ?>
                <tr>
                    ...
                    <td><?= $report['activityProgram'] ?></td>
                    <td><?= $report['documentationReflection'] ?></td>
